...
<head>
	<meta charset="utf-8">
	<title>Grafik Tingkat Kekeruhan Air Sungai Sibolahotang</title>
...
<body>
	...
	<h1 style = "text-align: center">Tingkat Kekeruhan Air Sungai Sibolahotang</h1>
	...
	<script>
		...
		const myChart = (chartType) => {
				$.ajax({
					url: baseUrl+'admin/chart_datakekeruhan',
					dataType: 'json',
					method: 'get',
					success: data => {
						let chartX = []
						...
						const chartData = {
							...
							datasets: [
								{
									label: 'Tingkat Kekeruhan Air (NTU)',
									data: chartY,
